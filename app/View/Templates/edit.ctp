            ...
            <div class="col-12">
                <div class="card" style="padding-bottom: 100px;">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Manage Templates Edit</h4>
                        ...
                        <div class="card-body card-dashboard">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-8 order-2 order-xl-1">
                                    <?php echo $this->Form->create('Templates', array('url' => array('controller' => 'Templates', 'action' => 'edit'), 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
                                    <div class="form-body">
                                        ...
                                        <div class="bgcolor" style="display: block;">
                                            <div class="form-group row">
                                        ...
                                        <div class="title_bgcolor" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="title_text_color" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="msgcolor" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="img_top" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="close_button_icon" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="full_image" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="btn_seprator" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="singlebtn" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="imageorlink" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="close_button_color" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div cass="image" style="display: block">
                                            <div class="form-group row">
                                                <label class="col-sm-3 label-control" for="message">Image Link : </label>
                                                <div class="col-sm-9">
                                                    <div class="controls">
                                        ...
                                        <div class="btnmargin" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="button1_text" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="button1_color" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="button1_text_color" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="button2_text" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="button2_color" style="display: block">
                                            <div class="form-group row">
                                        ...
                                        <div class="button2_text_color" style="display: block">
                                            <div class="form-group row">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 center">
                                                            <div class="overview-container" style="display: block">
                                                                <h1 class="text-center" style="display: block">No UI Selected</h1>
                                                            </div>
                                                            ...
                                                            <div id="notification_container" style=" position: relative;height: 400px; width: 310px;  margin-left: 6px; margin-top: -3px;display: none;">
                                                                ...
                                                                <div id="image_container" class="text-center" style="">
                                                                    <img class="img2" src="<?php echo URL_PATH; ?>uploads/image-placeholder-e1411098766130.jpg" style="height: 140px; width: 280px; "/>
                                                                </div>
    ...
    $(document).ready( function () {
        ...
        */
            ...
            if (image != '') {
                ...
                $('.img2').attr("src", '<?php echo URL_PATH; ?>uploads/image-placeholder-e1411098766130.jpg');
            }
        ...
        */
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo URL_PATH; ?>Templates/get_users',
            cache: true,
            success: function (data) {
        ...
        var id = url.slice(s + 1);

        $.ajax({
            type: 'post',
            url: '<?php echo URL_PATH; ?>Templates/rendertemplate',
            data: {
                'id': id
            },
            cache: true,
            success: function (data) {
                ...
                $.each(data1.Templates, function (index, value) {
                ...
                var template_type = data_arr["template_type"];
                if (template_type==1) {
                    $('#account').css('display', 'block');
                    $(".account").prop('required', true);
                    $('#application').css('display', 'block');
                ...
                var type = data_arr["type"];
                if (type==2) {
                    $('#notification_container').css('display', 'block');

                    var bgcolor = data_arr["bgcolor"];
                    $("#notification_container").css('background-color', bgcolor);

                    var button1_color = data_arr["button1_color"];
                    $("#button1_container").css('background-color', button1_color);

                    var button1_text = data_arr["button1_text"];
                    $("#img_button1_text").text(button1_text);

                    var button1_text_color = data_arr["button1_text_color"];
                    $("#img_button1_text").css('color', button1_text_color);

                    var button2_color = data_arr["button2_color"];
                    $("#button2_container").css('background-color', button2_color);

                    var button2_text = data_arr["button2_text"];
                    $("#img_button2_text").text(button2_text);

                    var button2_text_color = data_arr["button2_text_color"];
                    $("#img_button2_text").css('color', button2_text_color);

                    $("#msgcolor").prop('required', true);
                    $('.msgcolor').css('display', 'block');

                    var singlebtn = data_arr["singlebtn"];
                    if (singlebtn == 1) {
                        $('input[name="data[Template][singlebtn]"]').prop('checked',true);
                        $('#button2_container').css('display', 'none');
                        $('#button1_container').css('width', '310px');
                    } else {
                        $('#button2_container').css('display', 'inline-block');
                    ...
                    var btn_seprator = data_arr["btn_seprator"];
                    if (btn_seprator == 1) {
                        $('input[name="data[Template][btn_seprator]"]').prop('checked',true);
                        $('#btn_seprator').css('display', 'block');
                        $('#button1_container').css('height', '49px');
                        $('#button2_container').css('height', '49px');
                    } else {
                    ...
                    var close_button_icon = data_arr["close_button_icon"];
                    if (close_button_icon == 1) {
                        $('input[name="data[Template][close_button_icon]"]').prop('checked',true);
                        $('circle').css('fill', 'white');
                        $('text').css('fill', 'black');
                    } else {
                        $('circle').css('fill', 'black');
                    ...
                    var close_button_color = data_arr["close_button_color"];
                    $('circle').css('fill', close_button_color);

                    var close_button_exist = data_arr["close_button_exist"];
                    if (close_button_exist == 1) {
                        $('input[name="data[Template][close_button_exist]"]').prop('checked',true);
                        $('#close-container').css('display', 'block');
                        $("#close_button_color").prop('required', true);
                        $('.close_button_icon').css('display', 'block');
                        $('.close_button_color').css('display', 'block');
                    ...
                    var full_image = data_arr["full_image"];
                    if (full_image == 1) {
                        $('input[name="data[Template][full_image]"]').prop('checked',true);
                        $('.img2:visible').css('width', '310px');
                    } else {
                        $('.img2:visible').css('width', '280px');
                    }

                    var image = data_arr["image"];
                    if (image != '') {
                        $('.img2').attr("src", image);
                    } else {
                        $('.img2').attr("src", '<?php echo URL_PATH; ?>uploads/image-placeholder-e1411098766130.jpg');
                    ...
                    var img_top = data_arr["img_top"];
                    if (img_top == 1) {
                        $('input[name="data[Template][img_top]"]').prop('checked',true);
                        $('#title_container').insertAfter($('#image_container'));
                    } else {
                        $('#image_container').insertAfter($('#title_container'));
                    }
                    var msg = data_arr["msg"];
    //                    console.log("msg = "+msg);
                    if (msg != '') {
                        $(".msg_text").html(msg);
                    } else {
                    ...
                    var msgcolor = data_arr["msgcolor"];
                    $(".msg_text").css('color', msgcolor);

                    var title = data_arr["title"];
                    if (title != '') {
                        $(".title").html(title);
                    } else {
                        $(".title").html("Title Goes Here!");
                    ...
                    var title_bgcolor = data_arr["title_bgcolor"];
                    $("#title_container").css('background-color', title_bgcolor);

                    var title_text_color = data_arr["title_text_color"];
                    $(".title").css('color', title_text_color);
                    ...
                    $("#user_field").prop('required', true);
                    $('.user_field').css('display', 'block');
                    var user_field = data_arr["user_field"];
                    $('#user_field option[value='+user_field+']').attr('selected', true);
                    $('.img_top').css('display', 'none');
                    $('.close_button_exist').css('display', 'none');
                    $('.close_button_icon').css('display', 'none');
                    $('.full_image').css('display', 'none');
                    ...
                    var bgcolor = data_arr["bgcolor"];
                    $("#form_answer_container").css('background-color', bgcolor);
                    $(".forminput-container").css('background-color', bgcolor);
                    $("#form_answer_container").css('background-color', bgcolor);
                    ...
                    var button2_text = data_arr["button2_text"];
                    $("#form_button2_text").text(button2_text);
                    ...
                    var title_bgcolor = data_arr["title_bgcolor"];
                    $("#form_title_container").css('background-color', title_bgcolor);
                    ...
                    var bgcolor = data_arr["bgcolor"];
                    $("#radio_answer_container").css('background-color', bgcolor);
                    $(".radio-container").css('background-color', bgcolor);
                    $("#radio_answer_container").css('background-color', bgcolor);

                    var option1 = data_arr["option1"];
                    $(".option1_text").html(" "+option1);

                    var option2 = data_arr["option2"];
                    $(".option2_text").html(" "+option2);
                    ...
                    var button2_text = data_arr["button2_text"];
                    $("#radio_button2_text").text(button2_text);
                    ...
                    var title = data_arr["title"];
                    if (title != '') {
                        $(".radio_title").html(title);
                    } else {
                        $(".radio_title").html("Title Goes Here!");
                    }

                    var title_bgcolor = data_arr["title_bgcolor"];
                    $("#radio_title_container").css('background-color', title_bgcolor);
