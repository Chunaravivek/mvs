...
<div class="modal animated" id="modal-default" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <?php echo $this->Form->create('Ads', array('url' => array('controller' => 'Ads', 'action' => 'add'), 'class' => 'form form-horizontal', 'enctype' => 'multipart/form-data')); ?>
...
<div class="modal animated bd-example-modal-lg" id="edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Edit Ads</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script type="text/javascript" language="javascript" class="init">
    $(document).ready( function () {
        ...
        $('#acc_id').select2({
            ...
            width: '100%',
            ajax: {
                url: '<?php echo URL_PATH;?>Ads/AccountsSelect',
                dataType: 'json',
                data: function (data) {
                    return {
        ...
        var url = "<?php echo URL_PATH;?>Ads/records.json";
            ...
            aoColumns: [
                {
                    ...
                    "mRender": function (mData, type, full) {
                        return  '<input type="checkbox" id="checkall" class="video_checkbox" name="mydata" data-video-id=' + mData.Ads.id + '>';
                    },
                },
                {mData: 'Ads.id'},
                {mData: 'Ads.account_name',"searchable": false,"bSortable": false,"orderable": false},
                {mData: 'Ads.app_name'},
                {mData: 'Ads.json_path'},
                {mData: 'Ads.status','class':'project-status'},
                {mData: 'Ads.update_status'},
                {mData: 'Ads.created_date'},
                {mData: 'Ads.modified_date'},
                {
                    "targets": -1,
                    "searchable": false,
                    "data": null,
                    ...
                    "orderable": false,
                    "mRender": function(mData, type, full) {  
//                        var View = '<a href="#" class="btn btn-sm btn-app bg-info" data-backdrop="static" data-keyboard="false" title="View Ads" onclick="ViewModal('+mData.Ads.id+')"><i class="fas fa-info"></i></a>';
                        var edit = '<a href="javascript:void(0);" class="btn btn-primary btn-sm mr-2" data-target="#modal-edit" data-backdrop="static" data-keyboard="false" title="Edit Ads" onclick="EditModal('+mData.Ads.id+')"><i class="ft-edit-1"></i></a>';
                        var delete_id = '<a href="javascript:void(0);" class="btn btn-danger btn-sm" title="Delete Ads" onclick="deleteModal('+mData.Ads.id+')"><i class="ft-trash-2"></i></a>';
...
//                $('td', nRow).eq(0).html(iDisplayIndex + 1);
            ...
            "fnCreatedRow": function(nRow, mData, iDataIndex){ 
                if (mData.Ads.json_path === null) {
                    $('td:eq(4)', nRow).html("-");
                } else {
                    $('td:eq(4)', nRow).html("<a href='<?php echo API_URL_PATH;?>ads_json/"+mData.Ads.json_path+"_ad_id.json' target='_blank'>"+mData.Ads.json_path+"</a>");
                }
                
                if (mData.Ads.status == '1') {
                    $('td:eq(5)', nRow).html('<input type="checkbox" checked class="Ads_status" id="'+mData.Ads.id+'" data-group-cls="btn-group-sm" hidden="">');
                } else {
                    $('td:eq(5)', nRow).html('<input type="checkbox" class="Ads_status" id="'+mData.Ads.id+'" data-group-cls="btn-group-sm" hidden="">');
                }
                
                if (mData.Ads.update_status == '1') {
            ...
            "fnDrawCallback": function() {
                $('.Ads_status').checkboxpicker();
               
                $('.Ads_status:checkbox').checkboxpicker().on('change', function() {
                    var id = $(this).attr('id');
        ...
        $('#form-field-select-1').on('change', function(e) {
            ...
            $('#DataTables_Table_0').DataTable().ajax.url("Ads/records?acc_id="+acc_id).load();
        });
...
//        });
            ...
            buttons :  { 
                "MyButton" : {
                    ...
                    click: function(){
                        ...
                        window.location.href= "<?php echo $this->webroot; ?>Ads/delete/"+id;
                    }   
                }, 
                "MyButton1" : {
                    text: "Cancel",
    ...
    function EditModal(id) {
        ...
        $.ajax({
            ...
            dataType: '',
            data:{id:id}, 
            url:"<?php echo URL_PATH;?>Ads/edit",
            cache:false,
            success : function(data) {
        ...
        if (user.length <= 0) {
            ...
            cancelButtonText: "No, cancel plx!",
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo URL_PATH; ?>Ads/deleteAll',
                        data: {
                            id : selected_values
                        },
