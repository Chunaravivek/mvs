            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Manage PunjabiTextCategories2</h4>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add PunjabiTextCategories2</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <?php echo $this->Form->create('PunjabiTextCategories2', array('url' => array('controller' => 'PunjabiTextCategories2', 'action' => 'add'), 'class' => 'form form-horizontal', 'enctype' => 'multipart/form-data')); ?>
                <div class="modal-body">
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 label-control" for="tagline"> Tag Line : </label>
                            <div class="col-md-9 mx-auto">
                                <div class="controls">
                                    <?php
                                    echo $this->Form->input('tagline', array('error',
                                        'label' => false,
                                        'div' => false,
                                        'id' => 'tagline',
                                        'class' => 'form-control',
                        ...
                        <div class="form-group row color">
                            <label class="col-md-2 label-control" for="color"> Color : </label>
                            <div class="col-md-9 mx-auto">
                                <div class="controls">
                                    <?php
                                    echo $this->Form->input('color', array('error',
                                        'label' => false,
                                        'div' => false,
                                        'id' => 'color',
                                        'class' => 'form-control',
...
<div class="modal animated bounceIn bd-example-modal-lg" id="edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Edit Punjabi Text Categories2</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script type="text/javascript" language="javascript" class="init">
    $(document).ready( function () {
        $('#color').minicolors();
        var url = "<?php echo URL_PATH;?>PunjabiTextCategories2/records.json";
            ...
            aoColumns: [
                {
                    ...
                    "mRender": function (mData, type, full) {
                        return  '<input type="checkbox" id="checkall" class="video_checkbox" name="mydata" data-video-id=' + mData.PunjabiTextCategories2.id + '>';
                    },
                },
                {mData: 'PunjabiTextCategories2.id'},
                {mData: 'PunjabiTextCategories2.cat_name'},
                {mData: 'PunjabiTextCategories2.tagline'},
                {mData: 'PunjabiTextCategories2.color'},
                {mData: 'PunjabiTextCategories2.image'},
                {mData: 'PunjabiTextCategories2.order'},
                {mData: 'PunjabiTextCategories2.totalstatus'},
                {mData: 'PunjabiTextCategories2.status','class':'project-status'},
                {mData: 'PunjabiTextCategories2.created_date'},
                {mData: 'PunjabiTextCategories2.modified_date'},
                {
                    "targets": -1,
                    "searchable": false,
                    "data": null,
                    ...
                    "orderable": false,
                    "mRender": function(mData, type, full) {  
//                        var View = '<a href="#" class="btn btn-sm btn-app bg-info" data-backdrop="static" data-keyboard="false" title="View PunjabiTextCategories2" onclick="ViewModal('+mData.PunjabiTextCategories2.id+')"><i class="fas fa-info"></i></a>';
                        var edit = '<a href="javascript:void(0);" class="btn btn-primary btn-sm mr-2" data-target="#modal-edit" data-backdrop="static" data-keyboard="false" title="Edit PunjabiTextCategories2" onclick="EditModal('+mData.PunjabiTextCategories2.id+')"><i class="ft-edit-1"></i></a>';
                        var delete_id = '<a href="javascript:void(0);" class="btn btn-danger btn-sm title="Delete PunjabiTextCategories2" onclick="deleteModal('+mData.PunjabiTextCategories2.id+')"><i class="ft-trash-2"></i></a>';
...
//                $('td', nRow).eq(0).html(iDisplayIndex + 1);
            ...
            "fnCreatedRow": function(nRow, mData, iDataIndex){ 
                $('td:eq(5)', nRow).html('<img src="'+mData.PunjabiTextCategories2.image+'" class="media-object" width="64" height="64">');
                if (mData.PunjabiTextCategories2.status == '1') {
                    $('td:eq(8)', nRow).html('<input type="checkbox" checked class="PunjabiTextCategories2_status" id="'+mData.PunjabiTextCategories2.id+'" data-group-cls="btn-group-sm" hidden="">');
                } else {
                    $('td:eq(8)', nRow).html('<input type="checkbox" class="PunjabiTextCategories2_status" id="'+mData.PunjabiTextCategories2.id+'" data-group-cls="btn-group-sm" hidden="">');
                }
             
            },
            "fnDrawCallback": function() {
               $('.PunjabiTextCategories2_status').checkboxpicker();
               
                $('.PunjabiTextCategories2_status:checkbox').checkboxpicker().on('change', function() {
                    var id = $(this).attr('id');
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'PunjabiTextCategories2/update_status',
                        data: {
    ...
    $(function () { 
        $('#PunjabiTextCategories2AddForm').validate({
            errorElement: 'div',
            errorClass: 'help-block',
            focusInvalid: false,
            rules: {
                "data[PunjabiTextCategories2][cat_name]": {
                    required: true,
                },
                "data[PunjabiTextCategories2][cat_param]": {
                    required: true,
                },
                "data[PunjabiTextCategories2][tagline]": {
                    required: true,
                },
                "data[PunjabiTextCategories2][color]": {
                    required: true,
                },
                "data[PunjabiTextCategories2][image]": {
                    required: true,
                },
                "data[PunjabiTextCategories2][order]": {
                    required: true,
                },
            },
            ...
            buttons :  { 
                "MyButton" : {
                    ...
                    click: function(){
                        ...
                        window.location.href= "<?php echo $this->webroot; ?>PunjabiTextCategories2/delete/"+id;
                    }   
                }, 
                "MyButton1" : {
                    text: "Cancel",
    ...
    function EditModal(id) {
        ...
        $.ajax({
            ...
            dataType: '',
            data:{id:id}, 
            url:"<?php echo URL_PATH;?>PunjabiTextCategories2/edit",
            cache:false,
        ...
        if (user.length <= 0) {
            ...
            cancelButtonText: "No, cancel plx!",
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo URL_PATH; ?>PunjabiTextCategories2/deleteAll',
                        data: {
                            id : selected_values
                        },
