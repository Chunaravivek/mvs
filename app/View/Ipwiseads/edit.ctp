...
<?php
    echo $this->Form->create('Ipwiseads', array('url' => '/Ipwiseads/save/'.$id, 'class' => 'form form-horizontal', 'enctype' => 'multipart/form-data')); 
?>
<input hidden="" name="data[Ipwiseads][old_city_id]" value="<?= $city_id; ?>">
