            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Manage God Text Categories2</h4>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add God Text Categories2</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <?php echo $this->Form->create('GodTextCategories2', array('url' => array('controller' => 'GodTextCategories2', 'action' => 'add'), 'class' => 'form form-horizontal', 'enctype' => 'multipart/form-data')); ?>
...
<div class="modal animated bounceIn bd-example-modal-lg" id="edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Edit God Text Categories2</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script type="text/javascript" language="javascript" class="init">
    $(document).ready( function () {
        $('#color').minicolors();
        var url = "<?php echo URL_PATH;?>GodTextCategories2/records.json";
            ...
            aoColumns: [
                {
                    ...
                    "mRender": function (mData, type, full) {
                        return  '<input type="checkbox" id="checkall" class="video_checkbox" name="mydata" data-video-id=' + mData.GodTextCategories2.id + '>';
                    },
                },
                {mData: 'GodTextCategories2.id'},
                {mData: 'GodTextCategories2.cat_name'},
                {mData: 'GodTextCategories2.tagline'},
                {mData: 'GodTextCategories2.color'},
                {mData: 'GodTextCategories2.image'},
                {mData: 'GodTextCategories2.order'},
                {mData: 'GodTextCategories2.totalstatus'},
                {mData: 'GodTextCategories2.status','class':'project-status'},
                {mData: 'GodTextCategories2.created_date'},
                {mData: 'GodTextCategories2.modified_date'},
                {
                    "targets": -1,
                    "searchable": false,
                    "data": null,
                    ...
                    "orderable": false,
                    "mRender": function(mData, type, full) {  
//                        var View = '<a href="#" class="btn btn-sm btn-app bg-info" data-backdrop="static" data-keyboard="false" title="View GodTextCategories2" onclick="ViewModal('+mData.GodTextCategories2.id+')"><i class="fas fa-info"></i></a>';
                        var edit = '<a href="javascript:void(0);" class="btn btn-primary btn-sm mr-2" data-target="#modal-edit" data-backdrop="static" data-keyboard="false" title="Edit GodTextCategories2" onclick="EditModal('+mData.GodTextCategories2.id+')"><i class="ft-edit-1"></i></a>';
                        var delete_id = '<a href="javascript:void(0);" class="btn btn-danger btn-sm" title="Delete GodTextCategories2" onclick="deleteModal('+mData.GodTextCategories2.id+')"><i class="ft-trash-2"></i></a>';
...
//                $('td', nRow).eq(0).html(iDisplayIndex + 1);
            ...
            "fnCreatedRow": function(nRow, mData, iDataIndex){ 
                $('td:eq(5)', nRow).html('<img src="'+mData.GodTextCategories2.image+'" class="media-object" width="64" height="64">');
                if (mData.GodTextCategories2.status == '1') {
                    $('td:eq(8)', nRow).html('<input type="checkbox" checked class="GodTextCategories2_status" id="'+mData.GodTextCategories2.id+'" data-group-cls="btn-group-sm" hidden="">');
                } else {
                    $('td:eq(8)', nRow).html('<input type="checkbox" class="GodTextCategories2_status" id="'+mData.GodTextCategories2.id+'" data-group-cls="btn-group-sm" hidden="">');
                }
             
            },
            "fnDrawCallback": function() {
               $('.GodTextCategories2_status').checkboxpicker();
               
                $('.GodTextCategories2_status:checkbox').checkboxpicker().on('change', function() {
                    var id = $(this).attr('id');
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'GodTextCategories2/update_status',
                        data: {
    ...
    $(function () { 
        $('#GodTextCategories2AddForm').validate({
            errorElement: 'div',
            errorClass: 'help-block',
            focusInvalid: false,
            rules: {
                "data[GodTextCategories2][cat_name]": {
                    required: true,
                },
                "data[GodTextCategories2][cat_param]": {
                    required: true,
                },
                "data[GodTextCategories2][tagline]": {
                    required: true,
                },
                "data[GodTextCategories2][color]": {
                    required: true,
                },
                "data[GodTextCategories2][image]": {
                    required: true,
                },
                "data[GodTextCategories2][order]": {
                    required: true,
                },
            },
            ...
            buttons :  { 
                "MyButton" : {
                    ...
                    click: function(){
                        ...
                        window.location.href= "<?php echo $this->webroot; ?>GodTextCategories2/delete/"+id;
                    }   
                }, 
                "MyButton1" : {
                    text: "Cancel",
    ...
    function EditModal(id) {
        ...
        $.ajax({
            ...
            dataType: '',
            data:{id:id}, 
            url:"<?php echo URL_PATH;?>GodTextCategories2/edit",
            cache:false,
        ...
        if (user.length <= 0) {
            ...
            cancelButtonText: "No, cancel plx!",
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo URL_PATH; ?>GodTextCategories2/deleteAll',
                        data: {
                            id : selected_values
                        },
