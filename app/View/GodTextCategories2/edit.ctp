...
?>
<?php
    echo $this->Form->create('GodTextCategories2', array('url' => '/GodTextCategories2/save/'.$id, 'class' => 'form form-horizontal', 'enctype' => 'multipart/form-data')); 
?>
    ...
    <div class="form-body">
        ...
        <div class="form-group row" id="image_loc">
            ...
            <div class="col-md-9 mx-auto">
                <div class="controls">
                    <?php
                    if (isset($this->request->data['GodTextCategories2']['image']) && $this->request->data['GodTextCategories2']['image'] != '') {
                        echo "<p id='removed-p-tag'>";
                        echo "<img name='image' src=" .$this->request->data['GodTextCategories2']['image'] . " height='60px' width='60px'>";
                        echo "<button class='ui-button ui-widget ui-corner-all ml-1' id='confirm-delete-image' title='" . $this->request->data['GodTextCategories2']['image'] . "' data-id='".$this->request->data['GodTextCategories2']['id']."'><span class='ui-icon ft-image'></span>Delete Image</button>";
                        echo "</p>";
                    } else {
...
$(document).ready(function(){
    ...
    $('#GodTextCategories2EditForm').validate({
        errorElement: 'div',
    ...
    $(document).on('click', '#confirm-delete-image', function (e) {
        ...
        Swal.fire({
            ...
            if (result.value == true) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo URL_PATH; ?>GodTextCategories2/delete_image',
                    data: {
                        'id': id,
                    },
                    success: function (msg) {
                        $('#removed-p-tag').remove();
                        $('#image_loc').find('.controls').append('<input type="file" name="data[GodTextCategories2][image]" error="error" id="image1" class="form-control file" aria-required="true">');
