...
?>
<?php
    echo $this->Form->create('PunjabiTagTypes', array('url' => '/PunjabiTagTypes/save/'.$id, 'class' => 'form form-horizontal', 'enctype' => 'multipart/form-data')); 
...
//                delay: 250,
    ...
    $('#PunjabiTagTypesEditForm').validate({
        errorElement: 'div',
