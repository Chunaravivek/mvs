            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Manage Uidesigns</h4>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Uidesigns</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <?php echo $this->Form->create('Uidesigns', array('url' => array('controller' => 'Uidesigns', 'action' => 'add'), 'class' => 'form form-horizontal', 'enctype' => 'multipart/form-data')); ?>
                <div class="modal-body">
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 label-control" for="images"> Choose Image : </label>
                            <div class="col-md-9 mx-auto">
                                <div class="controls">
                                    <?php
...
<div class="modal animated bounceIn bd-example-modal-lg" id="edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Edit Uidesigns</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script type="text/javascript" language="javascript" class="init">
    $(document).ready( function () {
        ...
        var url = "<?php echo URL_PATH;?>Uidesigns/records.json";
            ...
            aoColumns: [
                {
                    ...
                    "mRender": function (mData, type, full) {
                        return  '<input type="checkbox" id="checkall" class="video_checkbox" name="mydata" data-video-id=' + mData.Uidesigns.id + '>';
                    },
                },
                {mData: 'Uidesigns.id'},
//                {mData: 'Uidesigns.tag_type',"searchable": false,"bSortable": false},
//                {mData: 'Uidesigns.tag_type_text',"searchable": false,"bSortable": false},
                {mData: 'Uidesigns.title'},
                {mData: 'Uidesigns.description'},
                {mData: 'Uidesigns.images'},
                {mData: 'Uidesigns.status','class':'project-status'},
                {mData: 'Uidesigns.created_date'},
                {mData: 'Uidesigns.modified_date'},
                {
                    "targets": -1,
                    "searchable": false,
                    "data": null,
                    ...
                    "orderable": false,
                    "mRender": function(mData, type, full) {  
//                        var View = '<a href="#" class="btn btn-sm btn-app bg-info" data-backdrop="static" data-keyboard="false" title="View Uidesigns" onclick="ViewModal('+mData.Uidesigns.id+')"><i class="fas fa-info"></i></a>';
                        var edit = '<a href="javascript:void(0);" class="btn btn-primary btn-sm mr-2" data-target="#modal-edit" data-backdrop="static" data-keyboard="false" title="Edit Uidesigns" onclick="EditModal('+mData.Uidesigns.id+')"><i class="ft-edit-1"></i></a>';
                        var delete_id = '<a href="javascript:void(0);" class="btn btn-danger btn-sm" title="Delete Uidesigns" onclick="deleteModal('+mData.Uidesigns.id+')"><i class="ft-trash-2"></i></a>';
...
//                $('td', nRow).eq(0).html(iDisplayIndex + 1);
            ...
            "fnCreatedRow": function(nRow, mData, iDataIndex){ 
                $('td:eq(4)', nRow).html('<img src="'+mData.Uidesigns.images+'" class="media-object" width="64" height="64">');
                if (mData.Uidesigns.status == '1') {
                    $('td:eq(5)', nRow).html('<input type="checkbox" checked class="Uidesigns_status" id="'+mData.Uidesigns.id+'" data-group-cls="btn-group-sm" hidden="">');
                } else {
                    $('td:eq(5)', nRow).html('<input type="checkbox" class="Uidesigns_status" id="'+mData.Uidesigns.id+'" data-group-cls="btn-group-sm" hidden="">');
                }
             
            },
            "fnDrawCallback": function() {
                $('.Uidesigns_status').checkboxpicker();
               
                $('.Uidesigns_status:checkbox').checkboxpicker().on('change', function() {
                    var id = $(this).attr('id');
            ...
            buttons :  { 
                "MyButton" : {
                    ...
                    click: function(){
                        ...
                        window.location.href= "<?php echo $this->webroot; ?>Uidesigns/delete/"+id;
                    }   
                }, 
                "MyButton1" : {
                    text: "Cancel",
    ...
    function EditModal(id) {
        ...
        $.ajax({
            ...
            dataType: '',
            data:{id:id}, 
            url:"<?php echo URL_PATH;?>Uidesigns/edit",
            cache:false,
        ...
        if (user.length <= 0) {
            ...
            cancelButtonText: "No, cancel plx!",
                ...
                if (result.value == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo URL_PATH; ?>Uidesigns/deleteAll',
                        data: {
                            id : selected_values
                        },
