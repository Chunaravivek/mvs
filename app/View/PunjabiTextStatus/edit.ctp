...
?>
<?php
    echo $this->Form->create('PunjabiTextStatus', array('url' => '/PunjabiTextStatus/save/'.$id, 'class' => 'form form-horizontal', 'enctype' => 'multipart/form-data')); 
    $options = array('' => $PunjabiTags);
?>
<div class="modal-body">
    <div class="form-body">
        <div class="form-group row">
            <label class="col-md-3 label-control"  for="tag_id1"> Tags : </label>
...
//                delay: 250,
    ...
    $('#PunjabiTextStatusEditForm').validate({
        errorElement: 'div',
